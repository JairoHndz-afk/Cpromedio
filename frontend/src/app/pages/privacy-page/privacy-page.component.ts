    ...
    <section class="section-block policy-shell">
      <div class="section-heading">
        <div>
          ...
          <h1>C&oacute;mo tratamos cookies, sesiones, boletines, comentarios y cuentas del sitio</h1>
          <p class="hero-copy">
            Este texto describe el funcionamiento t&eacute;cnico actual de Colombiano Promedio al 18 de agosto de 2026. Debe pasar por revisi&oacute;n legal antes de publicarse como pol&iacute;tica definitiva.
          </p>
        </div>
      ...
      <section class="policy-card">
        ...
        <div class="policy-list">
          ...
          <p>Los comentarios p&uacute;blicos pueden mostrarse con nombre visible, avatar opcional y filtros autom&aacute;ticos contra insultos frecuentes.</p>
          <p>Si te registras, tu cuenta queda asociada al mismo correo del bolet&iacute;n para comentar, editar tus aportes y administrar tu perfil.</p>
      ...
      <div class="policy-grid">
        <section class="policy-card">
          ...
          <div class="policy-list">
            ...
            <p><strong>Comentarios p&uacute;blicos:</strong> nombre visible, texto enviado, art&iacute;culo relacionado, fecha de publicaci&oacute;n, IP t&eacute;cnica de seguridad y avatar si existe una cuenta asociada.</p>
            <p><strong>Cuenta del sitio:</strong> nombre visible, correo, contrase&ntilde;a cifrada, foto de perfil, historial de comentarios y marcas de seguridad para cambios de acceso o sesi&oacute;n.</p>
        ...
        <section class="policy-card">
          ...
          <div class="policy-list">
            ...
            <p>Permitir el registro de cuentas del sitio para comentar, editar aportes propios y administrar perfil.</p>
            ...
            <p>Publicar comentarios y aplicar filtros autom&aacute;ticos de lenguaje ofensivo antes de mostrarlos.</p>
        ...
        <section class="policy-card">
          <p class="eyebrow">Comentarios y cuentas</p>
          <div class="policy-list">
            <p>Los comentarios enviados desde noticias publicadas pueden aparecer de forma inmediata si cumplen las reglas b&aacute;sicas del formulario.</p>
            <p>El sistema aplica una censura autom&aacute;tica sobre insultos frecuentes para reducir lenguaje ofensivo antes de publicar el texto.</p>
            <p>Si te registras, la cuenta queda con permisos de participaci&oacute;n: comentar, editar tus propios comentarios, cambiar contrase&ntilde;a y subir foto de perfil.</p>
            <p>El nombre visible de la cuenta solo puede cambiarse con una frecuencia controlada y el correo sigue vinculado a la suscripci&oacute;n del bolet&iacute;n.</p>
          </div>
        </section>
        ...
        <section class="policy-card">
          ...
          <div class="policy-list">
            ...
            <p>Puedes editar o retirar comentarios propios desde tu cuenta mientras sigan disponibles en el sitio.</p>
      ...
      <section class="policy-card">
        ...
        <div class="policy-list">
          ...
          <p>Este aviso cubre bolet&iacute;n, cuentas del sitio, comentarios p&uacute;blicos, seguridad, auditor&iacute;a, navegaci&oacute;n t&eacute;cnica y comunicados temporales del sitio; no reemplaza revisi&oacute;n jur&iacute;dica formal antes de producci&oacute;n.</p>
        </div>
      </section>
    </section>
  `,
...
export class PrivacyPageComponent {
  ...
  constructor() {
    this.seo.setHome({
      ...
      description: "Aviso técnico de privacidad, cookies, boletín, comentarios, cuentas del sitio, sesiones y manejo de datos en Colombiano Promedio."
    });
  }
